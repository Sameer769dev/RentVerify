export default function TermsOfServicePage() {
  return (
    <>
      ...
      <p>
        Welcome to GharBhada ("Company", "we", "our", "us")! These Terms of
        Service ("Terms", "Terms of Service") govern your use of our website
        located at gharbhada.com (together or individually "Service") operated by
        GharBhada. Our Privacy Policy also governs your use of our Service and
      ...
      <p>
        ...
        appropriateness. By posting Content on or through Service, you represent
        and warrant that the Content is yours (you own it) and/or you have the
        right to use it.
      </p>
